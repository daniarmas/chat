...
type MessageUsecase interface {
	ReceiveMessages(ctx context.Context, input inputs.ReceiveMessagesInput) (<-chan *entity.Message, error)
...
func (usecase *messageUsecase) ReceiveMessages(ctx context.Context, input inputs.ReceiveMessagesInput) (<-chan *entity.Message, error) {
